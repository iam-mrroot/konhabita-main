...
const categories = [
  ...
  { name: "Sustainability", link: "/projects/sustainability", active: true },
          ...
          <div ref={listRef} className="w-full lg:col-span-8 xl:col-span-9 space-y-8 sm:space-y-10">
            ...
            <div className="pt-6">
              <EnquiryCTA
                ...
                title="Commission a Sustainability & Net-Zero Carbon Project"
                subtitle="Collaborate directly with our environmental engineers on building physics CFD, LCA carbon audits, and LEED/GRIHA certification."
              />
            </div>
          </div>
        </div>
