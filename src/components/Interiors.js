...
const categories = [
  ...
  { name: "Interiors", link: "/projects/interiors", active: true },
          ...
          <div ref={listRef} className="w-full lg:col-span-8 xl:col-span-9 space-y-8 sm:space-y-10">
            ...
            <div className="pt-6">
              <EnquiryCTA
                ...
                title="Commission an Interior Architecture Project"
                subtitle="Collaborate directly with our interior designers on bespoke biophilic joinery, zero-VOC lime plaster walls, and acoustic calm."
              />
            </div>
          </div>
        </div>
