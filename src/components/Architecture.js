...
const categories = [
  ...
  { name: "Architecture", link: "/projects/architecture", active: true },
      ...
      <div className="mx-auto w-full max-w-[1500px] px-5 sm:px-8 md:px-10 lg:px-12 xl:px-16">
        <div className="mb-10 sm:mb-14 lg:mb-16 border-b border-[#0d4969]/15 pb-8">
          ...
          <p className="mt-3 max-w-2xl text-base leading-relaxed text-gray-500 sm:text-lg font-light">
            Civic landmarks, sustainable commercial campuses, cultural institutes, and climate-tuned private residences.
          </p>
        </div>
          ...
          <div ref={listRef} className="w-full lg:col-span-8 xl:col-span-9 space-y-8 sm:space-y-10">
            ...
            <div className="pt-6">
              <EnquiryCTA
                ...
                title="Commission an Architectural Design Project"
                subtitle="Collaborate directly with our lead architects on climate-responsive commercial campuses, cultural centers, and private villas."
              />
            </div>
          </div>
        </div>
