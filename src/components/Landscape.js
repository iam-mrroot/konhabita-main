...
import { ArrowRight, Sparkles, MapPin, X, Maximize2, Calendar } from "lucide-react";
import EnquiryCTA from "./EnquiryCTA";

gsap.registerPlugin(ScrollTrigger);

const categories = [
  { name: "Landscape", link: "/projects/landscape", active: true },
  ...
  { name: "Competition", link: "/projects/competition", active: false },
];
      ...
      <div className="mx-auto w-full max-w-[1500px] px-5 sm:px-8 md:px-10 lg:px-12 xl:px-16">
        <div className="mb-10 sm:mb-14 lg:mb-16 border-b border-[#0d4969]/15 pb-8">
          ...
          <p className="mt-3 max-w-2xl text-base leading-relaxed text-gray-500 sm:text-lg font-light">
            Civic parks, coastal waterfronts, ecological boardwalks, and sponge-city masterplans.
          </p>
        </div>
          ...
          <div ref={listRef} className="w-full lg:col-span-8 xl:col-span-9 space-y-8 sm:space-y-10">
            ...
            <div className="pt-6">
              <EnquiryCTA
                ...
                title="Commission a Landscape Architecture Project"
                subtitle="Collaborate directly with our landscape directors on parklands, waterfront promenades, and living sponge ecosystems."
              />
            </div>
          </div>
        </div>
